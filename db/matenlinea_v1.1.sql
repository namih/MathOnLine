...
START TRANSACTION;
USE `mathonline`;
INSERT INTO `mathonline`.`user` (`id_user`, `user_name`, `password`, `type_user`, `name`, `last_name`, `sex`, `year_birthday`, `id_unit_uam`, `email`, `uam_identifier`, `is_student`, `is_employed`, `registration_date`, `status`) VALUES (1, 'AdminMatEnLinea', '4dM1n@17', 1, 'Administrador', 'Mate en línea', NULL, NULL, 4, 'matenlinea.cbi@gmail.com', NULL, NULL, NULL, '2017-05-01 00:00:00', 1);
