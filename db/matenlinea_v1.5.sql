...
CREATE TABLE IF NOT EXISTS `mathonline`.`evaluation_test_log` (
  ...
  `status` TINYINT NOT NULL,
  PRIMARY KEY (`id_evaluation_test_log`, `id_user`),
  INDEX `fk_user_has_theme_user1_idx` (`id_user` ASC),
  INDEX `fk_evaluation_test_log_subtopic1_idx` (`id_subtopic` ASC),
...
START TRANSACTION;
USE `mathonline`;
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (1, 'airhostess', 'F', '/statics/img/avatar/airhostess.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (2, 'alien', 'H', '/statics/img/avatar/alien.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (3, 'alieness', 'F', '/statics/img/avatar/alieness.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (4, 'angel', 'H', '/statics/img/avatar/angel.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (5, 'aphrodite', 'F', '/statics/img/avatar/aphrodite.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (6, 'astronaut', 'H', '/statics/img/avatar/astronaut.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (7, 'canary', 'F', '/statics/img/avatar/canary.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (8, 'captainess', 'F', '/statics/img/avatar/captainess.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (9, 'catwoman', 'F', '/statics/img/avatar/catwoman.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (10, 'contractor', 'H', '/statics/img/avatar/contractor.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (11, 'dandy', 'H', '/statics/img/avatar/dandy.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (12, 'devil', 'H', '/statics/img/avatar/devil.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (13, 'doctor', 'H', '/statics/img/avatar/doctor.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (14, 'fairy', 'F', '/statics/img/avatar/fairy.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (15, 'female_dummy', 'F', '/statics/img/avatar/female_dummy.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (16, 'gangster', 'H', '/statics/img/avatar/gangster.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (17, 'king', 'H', '/statics/img/avatar/king.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (18, 'maid', 'F', '/statics/img/avatar/maid.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (19, 'male_dummy', 'H', '/statics/img/avatar/male_dummy.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (20, 'nick', 'F', '/statics/img/avatar/nick.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (21, 'ninja', 'H', '/statics/img/avatar/ninja.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (22, 'nun', 'F', '/statics/img/avatar/nun.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (23, 'nurse', 'F', '/statics/img/avatar/nurse.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (24, 'officer', 'H', '/statics/img/avatar/officer.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (25, 'priest', 'H', '/statics/img/avatar/priest.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (26, 'queen', 'F', '/statics/img/avatar/queen.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (27, 'robot', 'H', '/statics/img/avatar/robot.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (28, 'robotess', 'F', '/statics/img/avatar/robotess.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (29, 'sportsman', 'H', '/statics/img/avatar/sportsman.png', 1);
INSERT INTO `mathonline`.`avatar` (`id_avatar`, `name`, `gender`, `location`, `status`) VALUES (30, 'teacher', 'F', '/statics/img/avatar/teacher.png', 1);
...
START TRANSACTION;
USE `mathonline`;
INSERT INTO `mathonline`.`user` (`id_user`, `user_name`, `password`, `type_user`, `id_avatar`, `name`, `last_name`, `sex`, `year_birthday`, `email`, `id_degree`, `uam_identifier`, `is_student`, `is_employed`, `registration_date`, `status`) VALUES (1, 'AdminMatEnLinea', '1rxKMj42HBeT3HHYpzQnU9pAL0jsG7mpegAjmCmTWK+eN55P0jcpebohu52R7lAPMMI+CSVX3wg0kGXRc4Gbeg==', 1, 16, 'Administrador', 'Mate en línea', NULL, NULL, 'matenlinea.cbi@gmail.com', 1, 'NULL', NULL, NULL, '2017-05-01 00:00:00', 1);
