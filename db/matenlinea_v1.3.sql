...
START TRANSACTION;
USE `mathonline`;
INSERT INTO `mathonline`.`user` (`id_user`, `user_name`, `password`, `type_user`, `name`, `last_name`, `sex`, `year_birthday`, `email`, `id_degree`, `uam_identifier`, `is_student`, `is_employed`, `registration_date`, `status`) VALUES (1, 'AdminMatEnLinea', '1rxKMj42HBeT3HHYpzQnU9pAL0jsG7mpegAjmCmTWK+eN55P0jcpebohu52R7lAPMMI+CSVX3wg0kGXRc4Gbeg==', 1, 'Administrador', 'Mate en línea', NULL, NULL, 'matenlinea.cbi@gmail.com', 1, 'NULL', NULL, NULL, '2017-05-01 00:00:00', 1);
