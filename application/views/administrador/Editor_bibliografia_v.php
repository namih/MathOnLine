...
<div class="container" style="margin-top:15%;">
	...
	<div class="container-fluid">
		<div class="input-group col-lg-12 col-md-12 col-xs-12">
			...
			<div class="form-group has-feedback col-md-6  col-xs-12">
				<label>Tema</label>
				<input type="text" class="form-control" id="tema" value="<?php echo $id_theme ?>">
			</div>
			<div class="form-group col-md-6  col-xs-12">
				<button onclick="get_bibliografia()" type="button" class="btn btn-success">Actualizar</button>
	    	</div>
	    	<label style="display: none" id="id_usuario"><?php echo $id_user ?> </label>
			<label style="display: none" id="id_biblio"><?php echo $id_bibliography ?> </label>
	</div>
