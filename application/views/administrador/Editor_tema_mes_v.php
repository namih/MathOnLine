...
<div class="container" style="margin-top:15%;">
	...
	<div class="container-fluid">
		...
		<div class="form-group has-feedback col-md-6  col-xs-12"  >
			...
			<img width="70%" id="img_titulo" class="img-responsive" src="..<?php echo $image ?>"/><small><strong>NOTA: La imagen deberá tener como ancho tres veces la altura</strong></small>
