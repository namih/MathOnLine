<html>
	<div align="center">
		...
		<div style="background-color: #57A519">
			<div align="center">
				<p style="color: #57A519">.</p>
				<img style="border:100px" width="25%" src="http://turing.izt.uam.mx/tester/variacion6IztInv.png" >
			</div>
		</div>
		<div>
			<div align="left">
				<img width="15%" src="http://turing.izt.uam.mx/tester/mate1.jpg" >
				<h2 style="font-family:Helvetica">Solicitud de recuperación de contraseña</h2>
			</div>
			<div>
				...
				<div>
					<br />
					<p align="center" style="font-family:Helvetica">Nombre de usuario: <strong><?php echo $user_name ?></strong> </p>
					<p align="center" style="font-family:Helvetica">Su contraseña es: <strong><?php echo $password ?></strong> </p>
					<br />
