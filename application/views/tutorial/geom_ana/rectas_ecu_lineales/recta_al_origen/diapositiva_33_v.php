...
<script type="text/javascript" charset="utf-8">
	var applet0 = new GGBApplet({filename: base_url+"statics/ggb/tutorial/geom_ana/rectas_ecu_lineales/recta_al_origen/diapositiva_33.ggb","showToolbar":false, height: 300	}, true);
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" align="left">
							<div class="pregunta paso_0">
								<p>3. Encuentra la ecuación de la recta pasa por el origen y por el punto <math xmlns="http://www.w3.org/1998/Math/MathML"><mi>P</mi><mo>(</mo><mo>&#xA0;</mo><mo>-</mo><mn>6</mn><mo>,</mo><mo>&#xA0;</mo><mo>-</mo><mn>1</mn><mo>&#xA0;</mo><mo>)</mo></math></p>
							</div><br>
							<div class="paso_1">
								<p>
									...
									<mi>
										<semantics>
											<annotation-xml encoding="application/xhtml+xml">
												<input class="n_float" type="text" name="input_1" id="input_1" onchange="validaInputRelacion('-1','input_1','');" onkeypress="return validarSoloFlotante(event,'input_1');" xmlns="http://www.w3.org/1999/xhtml" style="text-align:center" size="5"/>
											</annotation-xml>
										</semantics>			
									</mi>
									<mi>
									...
									<mi>
										<semantics>
											<annotation-xml encoding="application/xhtml+xml">
												<input class="n_float" type="text" name="input_3" id="input_3" onchange="validaInputRelacion('0','input_3','.16');" onkeypress="return validarSoloFlotante(event,'input_3');" xmlns="http://www.w3.org/1999/xhtml" style="text-align:center" size="3"/>
											</annotation-xml>
										</semantics>		
									</mi>
									<mi>x</mi></math>
