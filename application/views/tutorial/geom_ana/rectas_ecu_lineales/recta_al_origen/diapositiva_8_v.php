...
<script type="text/javascript" charset="utf-8">
	var applet0 = new GGBApplet({filename: base_url+"statics/ggb/tutorial/geom_ana/rectas_ecu_lineales/recta_al_origen/diapositiva_8.ggb","showToolbar":false, height: 300	}, true);
