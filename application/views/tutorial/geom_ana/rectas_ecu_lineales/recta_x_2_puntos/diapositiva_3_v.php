...
<div class="container-fluid">
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
		...
		<div class="instruccion">
			<p>	Resuelve los ejercicios que están más abajo.
			<br></p>
		</div>
		<div id="boxEjemplos_1">
			<div id="box_1_ejemplo_0">
				<div class="pregunta"><p>Ejercicios</p>
				</div>
				<div class="instruccion">
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" align="center">
							...
							<div class="paso_1">
								<p>Considera Ia recta que pasa por los puntos Q(5, 5) y R(9, 6)</p>
							</div><br>
							<div class="paso_2">
								<p>La pendiente vale: m=</p>
							</div><br>
						</div>
