...
<script type="text/javascript" charset="utf-8">
    var applet0 = new GGBApplet({filename: base_url+"statics/ggb/tutorial/geom_ana/rectas_ecu_lineales/distancia_punto_a_recta/diapositiva_17.ggb","showToolbar":false, height: 300  }, true);
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" align="left">
							<div class="paso_6">
								...
								<p><span style="color:red;"><math xmlns="http://www.w3.org/1998/Math/MathML"><mi>y</mi><mo>=</mo><mn>2</mn><mi>x</mi><mo>-</mo><mn>5</mn></math></span> y <span style="color:blue;"><math xmlns="http://www.w3.org/1998/Math/MathML"><mi>y</mi><mo>=</mo><mo>-</mo><mn>0</mn><mo>.</mo><mn>5</mn><mi>x</mi><mo>+</mo><mn>1</mn><mo>.</mo><mn>5</mn></math></span></p>	
								<p>¿Cuál es el punto de intersección?</p>
								<p>Q( <math xmlns="http://www.w3.org/1998/Math/MathML">
									<mi>
										<semantics>
											<annotation-xml encoding="application/xhtml+xml">
												<input class="n_float" type="text" name="input_1" id="input_1" disabled="disabled" readonly="readonly" value="1.4" xmlns="http://www.w3.org/1999/xhtml" style="text-align:center" size="3"/>
											</annotation-xml>
										</semantics>										
									...
									<mi>
										<semantics>
											<annotation-xml encoding="application/xhtml+xml">
												<input class="n_float" type="text" name="input_2" id="input_2" disabled="disabled" readonly="readonly" value="-2.2" xmlns="http://www.w3.org/1999/xhtml" style="text-align:center" size="3"/>
											</annotation-xml>
										</semantics>										
									</mi></math> )</p>
							</div><br>
							<div class="paso_7">
								<p>Finalmente hay que encontrar la distancia entre los puntos <math xmlns="http://www.w3.org/1998/Math/MathML"><mi>P</mi><mo>(</mo><mo>&#xA0;</mo><mn>1</mn><mo>,</mo><mo>&#xA0;</mo><mo>-</mo><mn>2</mn><mo>&#xA0;</mo><mo>)</mo></math> y <math xmlns="http://www.w3.org/1998/Math/MathML"><mi>Q</mi><mo>(</mo><mo>&#xA0;</mo><mn>1</mn><mo>.</mo><mn>4</mn><mo>,</mo><mo>&#xA0;</mo><mo>-</mo><mn>2</mn><mo>.</mo><mn>2</mn><mo>&#xA0;</mo><mo>)</mo></math> </p>
								...
								<p><math xmlns="http://www.w3.org/1998/Math/MathML"><mi>d</mi><mo>(</mo><mo>&#xA0;</mo><mi>P</mi><mo>,</mo><mi>Q</mi><mo>&#xA0;</mo><mo>)</mo><mo>=</mo><msqrt><mi>
										<semantics>
											<annotation-xml encoding="application/xhtml+xml">
												<input class="n_float" type="text" name="input_3" id="input_3" onchange="validaInputRelacion('17','input_3','.8');" onkeypress="return validarSoloFlotante(event,'input_3');" xmlns="http://www.w3.org/1999/xhtml" style="text-align:center" size="3"/>
											</annotation-xml>
										</semantics>							
								</mi><mo>&#xA0;</mo></msqrt><mo>&#xA0;</mo><mo>=</mo><mo>&#x2009;</mo><mi>
										<semantics>
											<annotation-xml encoding="application/xhtml+xml">
												<input class="n_float" type="text" name="input_4" id="input_4" onchange="validaInputRelacion('4','input_4','.2');" onkeypress="return validarSoloFlotante(event,'input_4');" xmlns="http://www.w3.org/1999/xhtml" style="text-align:center" size="3"/>
											</annotation-xml>
										</semantics>							
								</mi><mo>&#xA0;</mo></math> </p>
