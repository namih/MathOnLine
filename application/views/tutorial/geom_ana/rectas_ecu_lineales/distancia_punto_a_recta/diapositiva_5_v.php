...
<script type="text/javascript" charset="utf-8">
    var applet0 = new GGBApplet({filename: base_url+"statics/ggb/tutorial/geom_ana/rectas_ecu_lineales/distancia_punto_a_recta/diapositiva_5.ggb","showToolbar":false, height: 300  }, true);
							...
							<div class="paso_3">
                                ...
                                <option value="11">-</option>
									...
									<mi>
										<semantics>
											<annotation-xml encoding="application/xhtml+xml">
												<input class="n_float" type="text" name="input_4" id="input_4" onchange="validaInputRelacion('2','input_4','');" onkeypress="return validarSoloEntero(event);" xmlns="http://www.w3.org/1999/xhtml" style="text-align:center" size="3"/>
											</annotation-xml>
										</semantics>									
									</mi>
									</mfrac></math> 
