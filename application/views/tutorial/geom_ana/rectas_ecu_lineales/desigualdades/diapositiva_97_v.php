                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="left">
                    <div class="paso_0">
						...
						<select>
							...
							<option> > </option>
							<option> = </option>
							<option> <math xmlns="http://www.w3.org/1998/Math/MathML"><mo>&#x2265;</mo></math> </option>
							<option> <math xmlns="http://www.w3.org/1998/Math/MathML"><mo>&#x2264;</mo></math> </option>
						</select> <input type="number" name=""> revistas.
						</p>
                    </div><br>
                    <div class="paso_1">
						<p> Para que la compañía tenga utilidades debe vender más de 35000 ejemplares.</p>
                    </div><br>
                </div>				
				<br>
			</div><br><br>
