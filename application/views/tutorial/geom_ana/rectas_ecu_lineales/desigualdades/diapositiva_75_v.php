...
<script type="text/javascript" charset="utf-8">
    var applet0 = new GGBApplet({filename: base_url+"statics/ggb/tutorial/geom_ana/rectas_ecu_lineales/desigualdades/diapositiva_75.ggb","showToolbar":false, height: 100  }, true);
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="left">
                            <div class="paso_0">
                                ...
                                <p>Resuelve primero el lado izquierdo <math xmlns="http://www.w3.org/1998/Math/MathML"><mi>q</mi></math> 
                                    ...
                                    </select> <input class="n_float" type="text" name="input_valor" id="input_valor" onchange="validaInputRelacion('1','input_valor','.44');" onkeypress="return validarSoloFlotante(event,'input_valor');">
