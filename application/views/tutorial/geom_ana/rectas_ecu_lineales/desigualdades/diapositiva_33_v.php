                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" align="left">
                            <div class="paso_0">
                                <p>Considera la desigualdad <math xmlns="http://www.w3.org/1998/Math/MathML"><mo>-</mo><mn>1</mn><mo>&gt;</mo><mo>-</mo><mn>4</mn></math>, ¿Cómo queda la desigualdad si le sumas 3 de los dos lados?</p>
                            </div><br>
                        </div>
