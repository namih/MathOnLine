...
<script type="text/javascript" charset="utf-8">
    var applet0 = new GGBApplet({filename: base_url+"statics/ggb/tutorial/geom_ana/rectas_ecu_lineales/desigualdades/diapositiva_45.ggb","showToolbar":false, height: 100  }, true);
                                ...
                                <div class="row">
                                    ...
                                    <p><br>
                                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                            <select class="form-control" id="select_tipo_grafica" onchange="validaOptSelect('00','select_tipo_grafica','1');">
