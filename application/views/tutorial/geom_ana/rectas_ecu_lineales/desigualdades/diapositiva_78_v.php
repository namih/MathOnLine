...
<script type="text/javascript" charset="utf-8">
    var applet0 = new GGBApplet({filename: base_url+"statics/ggb/tutorial/geom_ana/rectas_ecu_lineales/desigualdades/diapositiva_78.ggb","showToolbar":false, height: 100  }, true);
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="left">
                            <div class="paso_2"><br>
                                ...
                                <option value="001" >=</option>
                                </select> <input class="n_float" type="text" name="input_valor_2" id="input_valor_2" value="-1" disabled="disabled" readonly>
                                </p>
                                    ...
                                    <mi>
                                        <semantics>
                                            <annotation-xml encoding="application/xhtml+xml">
                                                <input class="n_float" type="text" name="input_1" id="input_1" onchange="validaInputRelacion('-1','input_1','');" onkeypress="return validarSoloEntero(event);" xmlns="http://www.w3.org/1999/xhtml" style="text-align:center" size="3"/>
                                            </annotation-xml>
                                        </semantics>                                        
                                    </mi><mo>,</mo>
                                    <mi>
                                        <semantics>
                                            <annotation-xml encoding="application/xhtml+xml">
                                                <input class="n_float" type="text" name="input_2" id="input_2" onchange="validaInputRelacion('1','input_2','.44');" onkeypress="return validarSoloFlotante(event,'input_2');" xmlns="http://www.w3.org/1999/xhtml" style="text-align:center" size="3"/>
                                            </annotation-xml>
                                        </semantics>                                        
                                    </mi>
                                    <mo>&#xA0;</mo><mo>)</mo></math> </p>
