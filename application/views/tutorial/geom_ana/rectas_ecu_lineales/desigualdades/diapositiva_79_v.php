...
<script type="text/javascript" charset="utf-8">
    var applet0 = new GGBApplet({filename: base_url+"statics/ggb/tutorial/geom_ana/rectas_ecu_lineales/desigualdades/diapositiva_79.ggb","showToolbar":false, height: 100  }, true);
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="left">
                            <div class="paso_0">
                                ...
                                <select  id="select_extremo" onchange="validaOptSelect('1','select_extremo','0');" >
                                    <option value="00" ></option>
                                    <option value="10" ><</option>
                                    <option value="11" >></option>
                                    <option  value="001">=</option>
                                </select> <input class="n_float" type="text" name="input_valor" id="input_valor" onchange="validaInputRelacion('0','input_valor','.36');" onkeypress="return validarSoloFlotante(event,'input_valor');">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="left" id="error_select_extremo">
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="left" id="error_input_valor">
                                    </div>
                                </p>
                            </div><br>
                        </div>
