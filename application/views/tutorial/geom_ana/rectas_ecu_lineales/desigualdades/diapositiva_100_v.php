			...
			<div id="box_1_ejemplo_0">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="left">
                    <div class="paso_0">
						...
						</select> <input class="n_float" type="text" name="input_2" id="input_2" disabled="disabled" readonly="readonly" value="35 000"> revistas.
						</p>
                    </div><br>
                    <div class="paso_1">
						<p> Para que la compañía tenga utilidades debe vender más de <b>35000</b> ejemplares.</p>
                    </div><br>
                </div>				
				<br>
			</div><br><br>
