...
<script type="text/javascript" charset="utf-8">
	var applet0 = new GGBApplet({filename: base_url+"statics/ggb/tutorial/geom_ana/rectas_ecu_lineales/recta_por_dos_puntos/diapositiva_38.ggb","showToolbar":false, height: 300	}, true);
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" align="left">
							<div class="paso_7">
								<p>Arrastra el punto naranja que está sobre el punto <math xmlns="http://www.w3.org/1998/Math/MathML"><msub><mi>P</mi><mn>1</mn></msub><mo>&#xA0;</mo></math>, colócalo sobre el eje X. ¿Cuánto mide la base del triángulo <math xmlns="http://www.w3.org/1998/Math/MathML"><mi>P</mi><mi>Q</mi><msub><mi>P</mi><mn>1</mn></msub><mo>&#xA0;</mo></math>? <input type="number" id="base_t" onchange="validaInputRelacion('2','base_t','');" onkeypress="return validarSoloNumero(event);" xmlns="http://www.w3.org/1999/xhtml" style="text-align:center" size="5" readonly="readonly" disabled="disabled" value="2"></p>
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="left">
							<div class="paso_11">
								<p>Tenemos que <math xmlns="http://www.w3.org/1998/Math/MathML"><mo mathcolor="#191919">&#xA0;</mo><mo mathcolor="#191919">&#xA0;</mo><mo mathcolor="#191919">&#xA0;</mo><mo mathcolor="#191919">&#xA0;</mo><mfrac mathcolor="#191919"><mrow><mn mathcolor="#0000FF">6</mn><mo mathcolor="#0000FF">-</mo><mn mathcolor="#0000FF">3</mn></mrow><mrow><mn mathcolor="#FF00FF">5</mn><mo mathcolor="#FF00FF">-</mo><mn mathcolor="#FF00FF">3</mn></mrow></mfrac><mo mathcolor="#191919">=</mo><mfrac mathcolor="#191919"><mn mathcolor="#0000FF">3</mn><mn mathcolor="#FF00FF">2</mn></mfrac><mo mathcolor="#191919">&#xA0;</mo><mo mathcolor="#191919">&#xA0;</mo><mo mathcolor="#191919">&#xA0;</mo><mo mathcolor="#191919">&#xA0;</mo><mo mathcolor="#191919">&#xA0;</mo></math> es la <b>pendiente</b> de la recta y se denota generalmente (pero no necesariamente) con una <b>m</b>. </p>
