					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" align="left">
							<div class="paso_7">
								...
								<p>¿Cuánto mide la base del triángulo <math xmlns="http://www.w3.org/1998/Math/MathML"><mi>P</mi><mi>Q</mi><msub><mi>P</mi><mn>1</mn></msub><mo>&#xA0;</mo></math>? <input type="number" id="base_t" onchange="validaInputRelacion('4','base_t','');" onkeypress="return validarSoloNumero(event);" xmlns="http://www.w3.org/1999/xhtml" style="text-align:center" size="5" readonly="readonly" disabled="disabled" value="4"></p>
							...
							<div class="paso_8">
								...
								<p>¿Cuánto mide la altura del triángulo <math xmlns="http://www.w3.org/1998/Math/MathML"><mi>P</mi><mi>Q</mi><msub><mi>P</mi><mn>1</mn></msub><mo>&#xA0;</mo></math>? <input type="number" id="altura_t" onchange="validaInputRelacion('2','altura_t','.67');" onkeypress="return validarSoloFlotante(event,'altura_t');" xmlns="http://www.w3.org/1999/xhtml" style="text-align:center" size="5"></p>
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="left" id="error_altura_t">
								</div>
							</div><br>
						</div>
