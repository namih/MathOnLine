...
<script type="text/javascript" charset="utf-8">
	var applet0 = new GGBApplet({filename: base_url+"statics/ggb/tutorial/geom_ana/rectas_ecu_lineales/recta_por_dos_puntos/diapositiva_18.ggb","showToolbar":false, height: 300	}, true);
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" align="left">
							...
							<div class="paso_4">
								...
								<p><input type="number" id="base_t" onkeypress="return validarSoloNumero(event,'base_t');" onchange="validaInputRelacion('3','base_t','');"  xmlns="http://www.w3.org/1999/xhtml" style="text-align:center" size="5"></p>
