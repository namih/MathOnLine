...
<script type="text/javascript" charset="utf-8">
	var applet0 = new GGBApplet({filename: base_url+"statics/ggb/tutorial/geom_ana/rectas_ecu_lineales/recta_por_dos_puntos/diapositiva_7.ggb","showToolbar":false, height: 300	}, true);
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" align="left">
							...
							<div class="paso_4">
								...
								<p><input type="number" id="base_t" onchange="validaInputRelacion('3','base_t','');" onkeypress="return validarSoloFlotante(event,'input_2');" xmlns="http://www.w3.org/1999/xhtml" style="text-align:center" size="5" value="3" readonly="readonly" disabled="disabled"></p>
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="left">
							<div class="paso_5">
								...
								<p><input type="number" id="altura_t" onchange="validaInputRelacion('4','altura_t','');" onkeypress="return validarSoloNumero(event);" xmlns="http://www.w3.org/1999/xhtml" style="text-align:center" size="3" value="4" readonly="readonly" disabled="disabled"></p>
								<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" align="left" id="error_altura_t">
								</div>
							</div><br>
							<div class="paso_6">
								<p>El cociente de los catetos del triángulo <math xmlns="http://www.w3.org/1998/Math/MathML"><mi>R</mi><mi>Q</mi><msub><mi>R</mi><mn>1</mn></msub><mo>&#xA0;</mo></math>es <math xmlns="http://www.w3.org/1998/Math/MathML"><mfrac><mrow><mn mathcolor="#0000FF">6</mn><mo mathcolor="#0000FF">-</mo><mn mathcolor="#0000FF">2</mn></mrow><mrow><mn mathcolor="#FF00FF">4</mn><mo mathcolor="#FF00FF">-</mo><mn mathcolor="#FF00FF">1</mn></mrow></mfrac><mo>=</mo><mfrac><mn mathcolor="#0000FF">4</mn><mn mathcolor="#FF00FF">3</mn></mfrac><mo>=</mo><mn>1</mn><mo>.</mo><mn>33</mn></math> <br> Este cociente es la pendiente de la recta.</p>
