...
<script type="text/javascript" charset="utf-8">
	var applet0 = new GGBApplet({filename: base_url+"statics/ggb/tutorial/geom_ana/rectas_ecu_lineales/recta_por_dos_puntos/diapositiva_70.ggb","showToolbar":false, height: 300	}, true);
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" align="left">
							...
							<div class="paso_8">
								<p>Si se resta la segunda coordenada de <b>P</b> menos la segunda coordenada de <b>Q</b>, en ese orden se obtiene: <math xmlns="http://www.w3.org/1998/Math/MathML"><mo><semantics>
											<annotation-xml encoding="application/xhtml+xml">
												<input class="n_float" type="text" name="input_2" id="input_2" onchange="validaInputRelacion('-0','input_2','.33');" onkeypress="return validarSoloFlotante(event,'input_2');" xmlns="http://www.w3.org/1999/xhtml" style="text-align:center" size="5" readonly="readonly" disabled="disabled" value="-0.33" />
											</annotation-xml>
										</semantics></mo></math> </p>
									<p>
