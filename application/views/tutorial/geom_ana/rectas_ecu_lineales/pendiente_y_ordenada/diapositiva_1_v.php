				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" align="left">
							...
							<div class="paso_2">
								<p>¿Qué sucede si cambias el coeficiente de x?</p>
							</div><br>
							<div class="paso_3">
							...
							<div class="paso_6">
								<p>El coeficiente de x en una función como y= 2x+ 3 se llama pendiente de Ia recta y usualmente se denota con Ia letra m. La pendiente nos indica qué tan inclinada está Ia recta.</p>
							</div><br>
							<div class="paso_7">
								<p>¿Qué sucede si cambiamos el valor de Ia constante?</p>
							</div><br>
							<div class="paso_8">
								<p>Observa qué sucede cuando el valor es negativo.</p>
							</div><br>
							<div class="paso_9">
								<p>Observa cómo cambia la gráfica al modificarse Ia constante. ¿Qué es lo que cambia? ¿Qué es lo que se mantiene igual?</p>
							</div><br>
							<div class="paso_10">
								<p>Esta constante se llama ordenada al origen y se suele denotar con Ia letra b. Observa que este valor nos da Ia intersección de Ia recta con el eje Y.</p>
							</div><br>
							<div class="paso_11">
								<p>Prueba cambiar los valores tanto del coeficiente de x (m) como de Ia ordenada al origen (b). y=2x + 1.29</p>
								<p>Observa lo que le sucede a Ia gráfica. ¿Qué sucede cuando m=0? ¿y cuando b=0?</p>
							</div><br>
							<div class="paso_12">
								<p>Prueba cambiar los valores tanto del coeficiente de x (m) como de Ia ordenada al origen (b). y=2x + 1.29</p>
								<p>Observa lo que le sucede a Ia gráfica.
¿Qué sucede cuando m=0? ¿y cuando b=0?

Tenemos entonces que cualquier recta que corte al eje Y puede representarse como y=mx+b, donde m representa la pendiente y b la ordenada al origen.</p>
							</div><br>
						</div>
