...
<script type="text/javascript" charset="utf-8">
    var applet0 = new GGBApplet({filename: base_url+"statics/ggb/tutorial/geom_ana/rectas_ecu_lineales/pendiente_y_ordenada/diapositiva_19.ggb","howToolbar":false, height: 300 }, true);
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" align="left">
                            ...
                            <p><label> ¿Cuál es su pendiente? <input class="n_float" type="text" name="pendiente" id="pendiente" disabled="disabled" readonly="readonly" value="-0.5"> </label>
                            </p>
                            <p><label> ¿Cuál es su intersección con el eje Y? <input class="n_float" type="text" name="inter_x" id="inter_x"  disabled="disabled" readonly="readonly" value="3"> </label>
                            </p>
                            <p><label> ¿Cuál es su intersección con el eje x? <input class="n_float" type="text" name="inter_y" id="inter_y" disabled="disabled" readonly="readonly" value="6"> </label>
                            </p>
