...
<script type="text/javascript" charset="utf-8">
	var applet0 = new GGBApplet({filename: base_url+"statics/ggb/tutorial/geom_ana/rectas_ecu_lineales/pendiente_y_ordenada/diapositiva_14.ggb","howToolbar":false, height: 300	}, true);
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
  						<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" align="left">
							...
							<p><label> ¿Cuál es su pendiente? <input class="n_float" type="text" name="pendiente" id="pendiente" onchange="validaInputRelacion('3','pendiente','');" onkeypress="return validarSoloNumero(event);"> </label>
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="left" id="error_pendiente">
									</div>
									</p>
							<p><label> ¿Cuál es su intersección con el eje Y? <input class="n_float" type="text" name="inter_x" id="inter_x"  onchange="validaInputRelacion('-1','inter_x','');" onkeypress="return validarSoloNumero(event);"> </label>
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="left" id="error_inter_x">
									</div>
							</p>
							<p><label> ¿Cuál es su intersección con el eje x? <input class="n_float" type="text" name="inter_y" id="inter_y" onchange="validaInputRelacion('0','inter_y','.33');" onkeypress="return validarSoloFlorante(event,'inter_y');"> </label>
