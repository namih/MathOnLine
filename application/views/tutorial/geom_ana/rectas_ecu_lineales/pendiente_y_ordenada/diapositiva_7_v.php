...
<script type="text/javascript" charset="utf-8">
	var applet0 = new GGBApplet({filename: base_url+"statics/ggb/tutorial/geom_ana/rectas_ecu_lineales/pendiente_y_ordenada/diapositiva_7.ggb","showToolbar":false, height: 300	}, true);
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" align="left">
							...
							<div class="paso_6">
								<p>El coeficiente de <math xmlns="http://www.w3.org/1998/Math/MathML"><mo>&#xA0;</mo><mi>x</mi><mo>&#xA0;</mo></math> en una función como <math xmlns="http://www.w3.org/1998/Math/MathML"><mi>y</mi><mo>=</mo><mn>2</mn><mi>x</mi><mo>+</mo><mn>3</mn></math> se llama pendiente de la recta y usualmente se denota con la letra <b>m</b>. La pendiente nos indica qué tan inclinada está la recta.</p>
							</div><br>
						</div>
					</div>
				</div><br>
