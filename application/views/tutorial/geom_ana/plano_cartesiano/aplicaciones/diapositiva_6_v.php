...
<script type="text/javascript" charset="utf-8">
	var applet = new GGBApplet({filename: base_url+"statics/ggb/dist_punto_d28.ggb","showToolbar":false, height: 500, "showMenuBar": false}, true);
...
<div class="container-fluid">
	...
	<div   class="col-md-12  col-xs-12" id="box" align="center">
		<p>¿Qué coordenadas tiene un punto C sobre el eje Y que equiste de los puntos A(5,5), B(4,2)?</p>
...
<br /><br />
	<input type="button" class="btn btn-success btn-sm" onclick="verificar6();" value="Verificar" />	
