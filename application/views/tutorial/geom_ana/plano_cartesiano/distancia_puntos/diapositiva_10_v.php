...
<script type="text/javascript" charset="utf-8">
	var applet = new GGBApplet({filename: base_url+"statics/ggb/dist_punto_d9.ggb","showToolbar":false, height: 500, "showMenuBar": false}, true);
...
<br />
<br />	
	<input type="button" class="btn btn-success btn-sm" onclick="verificar10();" value="Verificar" />	
