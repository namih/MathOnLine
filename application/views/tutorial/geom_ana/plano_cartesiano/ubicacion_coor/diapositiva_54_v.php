...
<div class="container-fluid">
	<div   class="col-md-6  col-xs-12" id="box" align="center">
		...
		<img class="img-responsive" src="<?php echo base_url(); ?>statics/img/tutorial/geom_ana/plano_cartesiano/ubicacion_coor/diapositiva_54.png" align="center"/>
	</div>	
	...
	<br /><br /><br />
	<input type="button" class="btn btn-success btn-sm" onclick="verificar54();" value="Verificar" />
</div>
