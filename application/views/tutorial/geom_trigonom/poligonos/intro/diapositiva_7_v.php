...
<div class="container-fluid">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <p>Entonces ¿cuántos grados crees que suman los ángulos interiores de un hexágono?</p>
    </div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <img class="img-responsive" src="<?php echo base_url(); ?>statics/img/tutorial/geom_trigonom/poligonos/intro/ejercicio_1.jpg" align="center"/>
        <br>
        ...
        <div class="form-group">
            ...
            <br><br>
            <button type="button" class="btn btn-success" onclick="anglesInPolygon(6)">Verificar</button>
        </div>
    </div>
</div>
