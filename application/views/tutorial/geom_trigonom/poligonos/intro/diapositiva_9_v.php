...
<div class="container-fluid">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ¿Cuántos grados suman los ángulos interiores de un octágono?
    </div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <img class="img-responsive" src="<?php echo base_url(); ?>statics/img/tutorial/geom_trigonom/poligonos/intro/ejercicio_3.jpg" align="center"/>
        <br>
        ...
        <div class="form-group">
            ...
            <br><br>
            <button type="button" class="btn btn-success" onclick="anglesInPolygon(8)">Verificar</button>
        </div>
    </div>
</div>
