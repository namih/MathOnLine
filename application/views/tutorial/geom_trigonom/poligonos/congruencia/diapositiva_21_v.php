...
<div class="container-fluid">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-justify">
        <p>Dados los siguientes triángulos congruentes, ¿cuál es el valor de los ángulos x y p?</p>
    </div>

    <div>
        <img class="img-responsive" src="<?php echo base_url(); ?>statics/img/tutorial/geom_trigonom/poligonos/congruencia/triangulo_20.png" align="center"/>
    </div>
    <br><br>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <button type="button" class="btn btn-success" onclick="correctAB(85, 65 )">Verificar</button>
        </div>
    </div>
