...
<div class="container-fluid">
    ...
    <div>
        <img class="img-responsive" src="<?php echo base_url(); ?>statics/img/tutorial/geom_trigonom/poligonos/congruencia/triangulo_26.png" align="center"/>
    </div>
    <br><br>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <button type="button" class="btn btn-success" onclick="correctAB(30,30)">Verificar</button>
        </div>
    </div>
