...
<script type="text/javascript" charset="utf-8">
	var applet = new GGBApplet({filename: base_url+"statics/ggb/circunferencia/circunferencia3.ggb","showToolbar":false, height: 390, width: 480,"showMenuBar": false}, true);
