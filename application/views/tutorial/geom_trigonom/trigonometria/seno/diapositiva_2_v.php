...
<script type="text/javascript" charset="utf-8">
	var applet = new GGBApplet({filename: base_url+"statics/ggb/circunferencia/circunferencia.ggb","showToolbar":false, height: 390, width: 480,"showMenuBar": false}, true);
