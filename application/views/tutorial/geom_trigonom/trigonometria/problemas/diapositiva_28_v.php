...
<div class="container-fluid">
	<div class="input-group col-lg-12 col-md-12 col-xs-12">
		...
		<div class="form-group has-feedback col-md-6  col-xs-12">
			...
			<p>Evaluamos el seno de 18° con una calculadora</p>
			...
			<p>Así que el avión ha recorrido 9.71 km cuando está a una altura de 3 km. Como va a una velocidad de 300 km/h, es decir, 5 km/min, entonces ha tardado</p>
	...
	<div id="resultado" style='display:none;'>
				<p>Así que el avión tarda 1.94 minutos en alcanzar una altura de 3000 metros.</p>
	</div>
</div>
