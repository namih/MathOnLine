...
<div class="container-fluid">
	<div class="input-group col-lg-12 col-md-12 col-xs-12">
		...
		<div class="form-group has-feedback col-md-6  col-xs-12">
			...
			<div style='display:none;' id="imagen2">
				<img class="img-responsive" width="39%" src="<?php echo base_url(); ?>statics/img/tutorial/geom_trigonom/trigonometria/problemas/diapositiva_5_1.png" align="center"/>
			</div>
			<div style='display:none;' id="imagen3">
				<img class="img-responsive" width="39%" src="<?php echo base_url(); ?>statics/img/tutorial/geom_trigonom/trigonometria/problemas/diapositiva_5_2.png" align="center"/>
			</div>
		</div>
		
	</div>
	<p>Evaluamos el seno de 65° usando una calculadora, teniendo cuidado que esté trabajando en grados y no en radianes. (Utiliza 4 números después del punto decimal)</p>
	...
	<div id="resultado2" style='display:none;'>
		<p>Asi que la escalera alcanzara una altura de 4.7128 metros.</p>
	</div>
</div>
