...
<div class="container-fluid">
	<div class="input-group col-lg-12 col-md-12 col-xs-12">
		...
		<div class="form-group has-feedback col-md-6  col-xs-12">
			...
			<p>Para contestar la primera pregunta debemos encontrar la altura, a, del avión después de 1 minuto. Necesitamos calcular primero la distancia c, que ha recorrido en 1 minuto si va a 300 km/h.</p>
		...
		<div class="form-group has-feedback col-md-6  col-xs-12">
			...
			<br />
			<div id="imagen">
				<img class="img-responsive" width="90%" src="<?php echo base_url(); ?>statics/img/tutorial/geom_trigonom/trigonometria/problemas/diapositiva_20.png" align="center"/>
			</div>
