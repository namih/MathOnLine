...
<div class="container-fluid">
	<div class="input-group col-lg-12 col-md-12 col-xs-12">
		<div class="form-group has-feedback col-md-6  col-xs-12">
			<p>Observa que, con el teorema de Pitágoras, obtenemos la medida del cateto opuesto, sin embargo, debido a la posición del triángulo en el plano cartesiano, el valor de x es negativo.</p>
