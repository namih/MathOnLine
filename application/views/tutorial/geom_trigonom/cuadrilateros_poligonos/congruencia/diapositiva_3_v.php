...
<div class="container-fluid">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-justify">
        <p>¿Los siguientes triángulos son congruentes entre si?</p>
    </div>

    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-justify">
            <img class="img-responsive" src="<?php echo base_url(); ?>statics/img/tutorial/geom_trigonom/poligonos/congruencia/triangulo_2.png" align="center"/>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-justify">
