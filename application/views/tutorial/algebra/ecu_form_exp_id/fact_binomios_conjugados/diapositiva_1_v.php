...
<div class="container-fluid">
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <img src="<?php echo base_url(); ?>statics/img/tutorial/algebra/fact_binomios_conjugados/fbc_1.jpg">
    </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-justify">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <math xmlns="http://www.w3.org/1998/Math/MathML"><mn>2</mn><mi>a</mi><mo>+</mo><mn>2</mn><mi>a</mi><mo>&#x2009;</mo></math>
        </div>
