...
<div class="container-fluid">
	...
	<h3><math xmlns="http://www.w3.org/1998/Math/MathML"><msup><mi>x</mi><mn>2</mn></msup><mo>=</mo><mn>24</mn></math></h3>
	<h3><math xmlns="http://www.w3.org/1998/Math/MathML"><msub><mi>x</mi><mn>1</mn></msub><mo>=</mo><mi>
		<semantics>
	  		<annotation-xml encoding="application/xhtml+xml">
	  			<input placeholder="0" xmlns="http://www.w3.org/1999/xhtml" style="text-align:center" type="text" size="1" id="valor_1" />
	  		</annotation-xml>
	  	</semantics>
	</mi><mo>,</mo><mo>&#xA0;</mo><msub><mi>x</mi><mn>2</mn></msub><mo>=</mo><mi>
		<semantics>
	  		<annotation-xml encoding="application/xhtml+xml">
	  			<input placeholder="0" xmlns="http://www.w3.org/1999/xhtml" style="text-align:center" type="text" size="1" id="valor_2" />
	  		</annotation-xml>
	  	</semantics>
	</mi></math></h3>
	...
	<button onclick="validar_43()" type="button" class="btn btn-success">Verificar</button>
</div>
<br />
<br />		
