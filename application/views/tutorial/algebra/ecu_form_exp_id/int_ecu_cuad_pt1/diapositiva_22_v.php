...
<div class="container-fluid">
	...
	<h3><math xmlns="http://www.w3.org/1998/Math/MathML"><msup><mi>x</mi><mn>2</mn></msup><mo>-</mo><mn>2</mn><mo>=</mo><mn>2</mn><msup><mi>x</mi><mn>2</mn></msup><mo>+</mo><mn>8</mn></math></h3>
	<p align="justify">Escribe la ecuación cuadrática de la forma general y encuentra los valores de a, b y c.</p>
	<h3><input placeholder="a" style="text-align: center" onchange="validar_22()" size="1" type="text" id="factor_a"> <input placeholder="b" style="text-align: center" onchange="validar_22()" size="1" type="text" id="factor_b"> <input placeholder="c" style="text-align: center" onchange="validar_22()" size="1" type="text" id="factor_c"></h3>
</div>
<br />
<br />		
