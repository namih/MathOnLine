...
<div class="container-fluid">
	...
	<h3><math xmlns="http://www.w3.org/1998/Math/MathML"><mo>-</mo><mn>3</mn><mi>x</mi><mo>=</mo><msup><mi>x</mi><mn>2</mn></msup><mo>+</mo><mn>2</mn></math></h3>
	<p align="justify">Escribe la ecuación cuadrática de la forma general y encuentra los valores de a, b y c.</p>
	<h3><input placeholder="a" style="text-align: center" onchange="validar_16()" size="1" type="text" id="factor_a"> <input placeholder="b" style="text-align: center" onchange="validar_16()" size="1" type="text" id="factor_b"> <input placeholder="c" style="text-align: center" onchange="validar_16()" size="1" type="text" id="factor_c"></h3>
</div>
<br />
<br />		
