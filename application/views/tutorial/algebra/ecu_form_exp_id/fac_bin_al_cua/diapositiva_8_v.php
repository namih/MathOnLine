...
<div class="container-fluid">
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-justify">
        <p>Utiliza las piezas para formar un cuadrado del lado que se indica.</p>
        <p>
            Lado = <math xmlns="http://www.w3.org/1998/Math/MathML"><mi>x</mi><mo>&#xA0;</mo><mo>+</mo><mo>&#xA0;</mo><mn>3</mn></math>
        </p>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <img src="<?php echo base_url(); ?>statics/img/tutorial/algebra/ecu_form_exp_id/respuesta_8.png">
                </div>
