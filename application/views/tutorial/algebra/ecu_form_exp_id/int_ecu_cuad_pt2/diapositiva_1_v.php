...
<div class="container-fluid">
	<div class="col-xs-12 col-sm-12 col-lg-12">
	  <p align="justify">Las ecuaciones cuadráticas pueden asociarse con funciones del tipo <math xmlns="http://www.w3.org/1998/Math/MathML"><mi>y</mi><mo>=</mo><mi>a</mi><msup><mi>x</mi><mn>2</mn></msup><mo>+</mo><mi>b</mi><mi>x</mi><mo>+</mo><mi>c</mi></math>, cuya gráfica representa una parábola. Observa como cambian las coordenadas del punto rojo al moverlo.</p>
	  ...
	  <p align="justify">Cambia el valor de x con las flechas y observa la ubicación del punto A(x,y) sobre la gráfica.</p>
	  <div class="btn-group" id="opciones" class="col-xs-12 col-sm-12 col-lg-12">
		...
		<button id="valor" type="button" class="btn">-</button>
