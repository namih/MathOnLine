...
<div class="container-fluid">
	<div>
		...
		<p>21, 23, 26, <input type="text" onblur="acierto(<?php echo $paginador['actual']; ?>)" id="1" size="4" />, <input type="text" onblur="acierto(<?php echo $paginador['actual']; ?>)" id="2" size="4" />, <input onblur="acierto(<?php echo $paginador['actual']; ?>)" type="text" id="3" size="4" /></p>
	</div>
