...
<div class="container-fluid">
	<div id="ejercicio1">
		...
		<p>Ahora completa los términos de la sucesión: <math xmlns="http://www.w3.org/1998/Math/MathML"><msub><mi>a</mi><mi>n</mi></msub><mo>=</mo><mn>10</mn><msub><mi>a</mi><mrow><mi>n</mi><mo>-</mo><mn>1</mn></mrow></msub><mo>,</mo><mo>&#xA0;</mo><mi>p</mi><mi>a</mi><mi>r</mi><mi>a</mi><mo>&#xA0;</mo><mi>n</mi><mo>=</mo><mn>2</mn><mo>,</mo><mo>.</mo><mo>.</mo><mo>.</mo><mo>,</mo><mn>6</mn></math></p>
		<p>10, <input type="text" style="text-align: center" onblur="acierto(<?php echo $paginador['actual']; ?>)" id="1" size="4" />, 
	...
	<div id="ejercicio2" style='display:none;'>
		...
		<p>6, <input type="text" style="text-align: center" onblur="acierto(<?php echo $paginador['actual']; ?>)" id="6" size="4" />, 
	...
	<div id="ejercicio3" style='display:none;'>
		<p>En general, una sucesión se puede definir a partir de su primer término y la fórmula de recurrencia que permite calcular los siguientes.</p>
		<p>Ahora completa los términos de la sucesión: <math xmlns="http://www.w3.org/1998/Math/MathML"><msub><mi>a</mi><mi>n</mi></msub><mo>=</mo><msup><mi>n</mi><mn>3</mn></msup><mo>,</mo><mo>&#xA0;</mo><mi>p</mi><mi>a</mi><mi>r</mi><mi>a</mi><mo>&#xA0;</mo><mi>n</mi><mo>=</mo><mn>2</mn><mo>,</mo><mo>.</mo><mo>.</mo><mo>.</mo><mo>,</mo><mn>6</mn></math></p>
		<p>1, <input type="text" style="text-align: center" onblur="acierto(<?php echo $paginador['actual']; ?>)" id="11" size="4" />, 
