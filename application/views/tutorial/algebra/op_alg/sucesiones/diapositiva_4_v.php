...
<div class="container-fluid">
	<div id="ejercicio1">
		...
		<p>52, 47, 42, <input type="text" style="text-align: center" onblur="acierto(<?php echo $paginador['actual']; ?>)" id="1" size="4" />, 
	...
	<div id="ejercicio2" style='display:none;'>
		<p>Una sucesión es una secuencia de números organizados de tal manera que cada uno de ellos se calcula a partir del anterior, siguiendo una regla específica.</p>
		<p>Intenta averiguar cuáles son los siguientes 3 términos de esta sucesión:</p>
		<p>90, 170, 240, <input type="text" style="text-align: center" onblur="acierto(<?php echo $paginador['actual']; ?>)" id="4" size="4" />, 
	...
	<div id="ejercicio3" style='display:none;'>
		<p>Una sucesión es una secuencia de números organizados de tal manera que cada uno de ellos se calcula a partir del anterior, siguiendo una regla específica.</p>
		<p>Intenta averiguar cuáles son los siguientes 3 términos de esta sucesión:</p>
		<p>1024, 512, 256, <input type="text" style="text-align: center" onblur="acierto(<?php echo $paginador['actual']; ?>)" id="7" size="4" />, 
