...
<div class="container-fluid">
	<div id="ejercicio1">
		...
		<p>52, <input type="text" style="text-align: center" onblur="acierto(<?php echo $paginador['actual']; ?>)" id="1" size="4" />, 
	...
	<div id="ejercicio2" style='display:none;'>
		...
		<p>90, <input type="text" style="text-align: center" onblur="acierto(<?php echo $paginador['actual']; ?>)" id="6" size="4" />, 
	...
	<div id="ejercicio3" style='display:none;'>
		...
		<p>1024, <input type="text" style="text-align: center" onblur="acierto(<?php echo $paginador['actual']; ?>)" id="11" size="4" />, 
