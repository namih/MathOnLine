...
<div class="container-fluid">
	<div>
		...
		<p><math xmlns="http://www.w3.org/1998/Math/MathML"><mi>d</mi><mo>=</mo></math> <input type="text" style="text-align: center" onblur="acierto(<?php echo $paginador['actual']; ?>)" id="2" size="1" /> / <input type="text" style="text-align: center" onblur="acierto(<?php echo $paginador['actual']; ?>)" id="3" size="1" /></p>
