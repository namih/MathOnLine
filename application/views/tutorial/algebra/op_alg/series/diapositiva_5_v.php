...
<div class="container-fluid">
	<div id="ejercicio1">
		<p>Encuentra el primer término <math xmlns="http://www.w3.org/1998/Math/MathML"><mi>a</mi></math> y la diferencia común 
			<math xmlns="http://www.w3.org/1998/Math/MathML"><mi>d</mi></math> para los siguientes casos:</p>
		<p>Si el término 3 es 20 y el término 12 es 56,</p>
		<p>el primer término <math xmlns="http://www.w3.org/1998/Math/MathML"><mi>a</mi></math> es 
			<input type="text" style="text-align: center" onblur="acierto(<?php echo $paginador['actual']; ?>)" id="1" size="4" />, 
			y la diferencia común <math xmlns="http://www.w3.org/1998/Math/MathML"><mi>d</mi></math> es 
	...
	<div id="ejercicio2" style='display:none;'>
		...
		<p>el primer término <math xmlns="http://www.w3.org/1998/Math/MathML"><mi>a</mi></math> es 
			...
			y la diferencia común <math xmlns="http://www.w3.org/1998/Math/MathML"><mi>d</mi></math> es 
			<input type="text" style="text-align: center" onblur="acierto(<?php echo $paginador['actual']; ?>)" id="4" size="4" />.</p>
	...
	<div id="ejercicio3" style='display:none;'>
		...
		<p>el primer término <math xmlns="http://www.w3.org/1998/Math/MathML"><mi>a</mi></math> es 
			...
			y la diferencia común <math xmlns="http://www.w3.org/1998/Math/MathML"><mi>d</mi></math> es 
			<input type="text" style="text-align: center" onblur="acierto(<?php echo $paginador['actual']; ?>)" id="6" size="4" />.</p>
