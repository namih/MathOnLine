...
<div class="container-fluid">
	<div>
		...
		<p><math xmlns="http://www.w3.org/1998/Math/MathML"><msub><mi>S</mi><mi>n</mi></msub><mo>=</mo></math> <input type="text" id="1" size="4" /></p>
		<input type="button" class="btn btn-success btn-sm" onclick="" value="Más ejercicios" />
	</div>
 </div>		
