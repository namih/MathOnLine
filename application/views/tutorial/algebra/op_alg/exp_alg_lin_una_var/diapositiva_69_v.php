...
<div class="container-fluid">
	<div id="ejercicio1">
		<p>Aumenta o disminuye los rectángulos y cuadros necesarios para formar una figura que tenga el valor que se indica, mediante los pulsadores.</p>
		...
		<div style="margin-bottom: 20px"  class=" col-lg-12 col-md-12  col-xs-12">
				<div  class=" col-lg-6 col-md-6  col-xs-12">
					...
					<div class="btn-group" id="opciones1">
						<button onclick="decrementar_69_1()" type="button" class="btn btn-info"><</button>
						<button onclick="incrementar_69_1()" type="button" class="btn btn-info">></button>
					</div>
				</div>
				<div  class=" col-lg-6 col-md-6  col-xs-12">
					<div class=" col-lg-12 col-md-12  col-xs-12">
					...
					<div class="btn-group" id="opciones3">
						<button onclick="decrementar_69_3()" type="button" class="btn btn-info"><</button>
						<button onclick="incrementar_69_3()" type="button" class="btn btn-info">></button>
					</div>
				</div>
		</div>
	...
	<div id="ejercicio2" style='display:none;'>
		<p>Aumenta o disminuye los rectángulos y cuadros necesarios para formar una figura que tenga el valor que se indica, mediante los pulsadores.</p>
		<p><math xmlns="http://www.w3.org/1998/Math/MathML"><mi>n</mi><mo>&#xA0;</mo><mo>+</mo><mo>&#xA0;</mo><mn>5</mn></math></p>
		<div style="margin-bottom: 20px"  class=" col-lg-12 col-md-12  col-xs-12">
				<div  class=" col-lg-6 col-md-6  col-xs-12">
					<div class=" col-lg-12 col-md-12  col-xs-12">
	...
	<div id="ejercicio3" style='display:none;'>
		<p>Aumenta o disminuye los rectángulos y cuadros necesarios para formar una figura que tenga el valor que se indica, mediante los pulsadores.</p>
		<p><math xmlns="http://www.w3.org/1998/Math/MathML"><mn>2</mn><mo>(</mo><mi>n</mi><mo>&#xA0;</mo><mo>+</mo><mo>&#xA0;</mo><mn>2</mn><mo>)</mo></math></p>
		<div style="margin-bottom: 20px"  class=" col-lg-12 col-md-12  col-xs-12">
				<div  class=" col-lg-6 col-md-6  col-xs-12">
					<div class=" col-lg-12 col-md-12  col-xs-12">
