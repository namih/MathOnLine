...
<div class="container-fluid">
	<div>
		...
		<p><math xmlns="http://www.w3.org/1998/Math/MathML"><mn>2</mn><mi>x</mi><mo>+</mo><mfrac><mi>x</mi><mn>4</mn></mfrac><mo>+</mo><mn>8</mn><mo>=</mo></math><input type="text" style="text-align: center" onblur="acierto(<?php echo $paginador['actual']; ?>)" id="1" size="4" />x + 8</p><br />
