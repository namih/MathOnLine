<div class="container-fluid">
	<p>Se quiere llenar un tanque de 200 litros y se esta verificando la calidad de la bomba de agua. Para ello, se utilizan mangueras con diferetes diámentros
        ...
        <p>Si queremos que el tiempo de llenado disminuya a la mitad, el diámetro de la manguera debe:</p>
			<form method="post" action="#">
				<table>
					<td align="left">
						<input type="checkbox" id="1" /> Aumentarse al triple<br />
						<input type="checkbox" id="2" /> Disminuirse a la mitad<br />
						<input type="checkbox" id="3" /> Aumentarse al doble<br /><br />
					</td>
				</table>
			</form>
