...
<div class="container-fluid">
	...
	<div style="margin-bottom: 20px" class="col-xs-12 col-sm-12 col-lg-12">
		<div class="col-xs-12 col-sm-12 col-lg-12">
		  <h1><math xmlns="http://www.w3.org/1998/Math/MathML"><mfrac><mn>2</mn><mn>4</mn></mfrac><mo>&#xA0;</mo><mo>=</mo><mo>&#xA0;</mo><mfrac><mo>?</mo><mn>8</mn></mfrac></math> <input placeholder="?" style="text-align: center" onchange="validar()" size="1" type="text" id="incognita"></h1>
		  <br />
