...
<div class="container-fluid">
	<p align="justify">El estacionamiento E tiene el 20% de sus espacios ocupados. Si hay 80 lugares. ¿Cuántos se encuentran ocupados? Completa según indica la barra.</p>
	<div class="col-xs-12 col-sm-12 col-lg-12">
		<div class="col-xs-12 col-sm-4 col-lg-4">
			<img style="margin-top: 20px" class="img-responsive" src="<?php echo base_url(); ?>statics/img/tutorial/numeros/fracc_pct_rzns_pro/parking_e20.png" />
		</div>
		<div style="margin-bottom: 20px" class="col-xs-12 col-sm-8 col-lg-8">
			...
			<button onclick="validar_32()" type="button" class="btn btn-success">Validar</button>
		</div>
	</div>
	<p align="justify">Observa que el 20% es equivalente a <math xmlns="http://www.w3.org/1998/Math/MathML"><mfrac><mn>1</mn><mn>5</mn></mfrac></math></p>
</div>