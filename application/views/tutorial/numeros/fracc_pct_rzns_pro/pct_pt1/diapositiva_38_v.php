...
<div class="container-fluid">
	<p align="justify">¿Cuántos lugares disponibles tiene el estacionamiento E7 si sabemos que, igual que E3, está al 60% de su capacidad y que tiene 36 lugares ocupados? Completa la tabla.</p>
	<div class="col-xs-12 col-sm-12 col-lg-12">
		...
		<button onclick="validar_38()" type="button" class="btn btn-success">Validar</button>
	</div>
	<div class="col-xs-12 col-sm-12 col-lg-12">
