...
<div class="container-fluid">
 	<p align="left">Otra manera de encontrar el resultado de una suma de números mixtos consiste en convertirlos en fracciones antes de sumar.
                           ¿Cómo escribirías el número <math xmlns="http://www.w3.org/1998/Math/MathML"><mn>1</mn><mfrac><mn>1</mn><mn>2</mn></mfrac></math>?</p>
   	<div class=" col-lg-12 col-md-12  col-xs-12">
		<div class=" col-lg-12 col-md-12  col-xs-12">
				<table>
					<tr align="center">
						<td align="center"><img class="img-responsive" style="margin: 20px" width="40%" src="<?php echo base_url(); ?>statics/img/tutorial/numeros/fracc_pct_rzns_pro/tres_medios_azul.png"/></td>
					</tr>
				</table>
			</div>
			<div class=" col-lg-12 col-md-12  col-xs-12">
				<table>
					<tr align="center">
						<td align="center"><p>Cuántos medios hay en un entero?</p></td>
			...
			<div class=" col-lg-12 col-md-12  col-xs-12">
				<table>
					<tr align="center">
						<td align="left"><p>¿Cuántos medios  hay en total?</p></td>
							<td>
								<h3>
		...
		<p align="left">Observa que para escribir el número mixto como fracción podemos sumar las partes correspondientes a los enteros <math xmlns="http://www.w3.org/1998/Math/MathML"><mfrac><mn>2</mn><mn>2</mn></mfrac></math> y la fracción que forma el número mixto <math xmlns="http://www.w3.org/1998/Math/MathML"><mfrac><mn>1</mn><mn>2</mn></mfrac></math> .</p>
