<div class="container-fluid">
		...
		<div style="margin-bottom: 20px"  class=" col-lg-12 col-md-12  col-xs-12">
				...
				<div  class=" col-lg-4 col-md-4  col-xs-12">
					<div class=" col-lg-12 col-md-12  col-xs-12">
						<img class="img-responsive" width="50%" src="<?php echo base_url(); ?>statics/img/tutorial/numeros/fracc_pct_rzns_pro/doceavos.png"/>
					</div>
					<div class=" col-lg-12 col-md-12  col-xs-12">
						<h1><math xmlns="http://www.w3.org/1998/Math/MathML"><mfrac><mn>0</mn><mn>12</mn></mfrac></math></h1>
					</div>					
