	...
	<div id="second" style="display: none">
		...
		<div style="margin-bottom: 20px"  class=" col-lg-12 col-md-12  col-xs-12">
			...
			<div  class=" col-lg-4 col-md-4  col-xs-12">
				...
				<div class=" col-lg-12 col-md-12  col-xs-12">
					<h1 id="total"><math xmlns="http://www.w3.org/1998/Math/MathML"><mfrac><mn>0</mn><mn>2</mn></mfrac></math></h1>
				</div>					
				<div class="btn-group" id="opciones">
					<button onclick="decrementar_3 ()" type="button" class="btn btn-info"><</button>
					<button onclick="incrementar_3 ()" type="button" class="btn btn-info">></button>
	...
	<div id="third" style="display: none">
		...
		<div style="margin-bottom: 20px"  class=" col-lg-12 col-md-12  col-xs-12">
			...
			<div  class=" col-lg-4 col-md-4  col-xs-12">
				...
				<div class=" col-lg-12 col-md-12  col-xs-12">
					<h1 id="total"><math xmlns="http://www.w3.org/1998/Math/MathML"><mfrac><mn>0</mn><mn>8</mn></mfrac></math></h1>
				</div>					
				<div class="btn-group" id="opciones">
					<button onclick="decrementar_3 ()" type="button" class="btn btn-info"><</button>
					<button onclick="incrementar_3 ()" type="button" class="btn btn-info">></button>
