...
<script type="text/javascript" charset="utf-8">
	var applet = new GGBApplet({filename: base_url+"statics/ggb/int_val_abs/diapositiva_1.ggb","showToolbar":false, height: 200, width: 700,"showMenuBar": false}, true);
	window.addEventListener("load", function() {
        applet.inject('grafica');
    });
</script>
...
<div class="container-fluid">
	<div  align="left" class=" col-lg-12 col-md-12  col-xs-12">
		...
		<div align="justify" class=" col-lg-12 col-md-12  col-xs-12" id="grafica">
