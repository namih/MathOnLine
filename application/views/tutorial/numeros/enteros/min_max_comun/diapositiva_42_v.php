...
<div class="container-fluid">
	...
	<div class="table-responsive div-border0">
		...
		<input class="input-sm input-top5" size="10" type="text" id="num1" />
		<p>¿Cuántos niños hay en cada equipo?</p>
		<input class="input-sm input-top5" size="10" type="text" id="num2" />
		<p>¿Cuántos niñas hay en cada equipo?</p>
		<input class="input-sm input-top5" size="10" type="text" id="num3" />
	</div>	
    <br /><br />
