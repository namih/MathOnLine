...
<div class="container-fluid">
	...
	<input class="input-sm input-top5" size="5" type="text" id="2" readonly=""/> <label> X </label> <input class="input-sm input-top5" size="5" type="text" id="3" readonly=""/>  <label> X </label> <input class="input-sm input-top5" size="5" type="text" id="4" readonly=""/><label>  = </label> <input class="input-sm input-top5" size="3" type="text" id="5" />
	</div>
	<br /><br />
