	...
	<div class="col-md-6  col-xs-12 table-responsive div-border0" id="tab" align="center">
		 <table class="table table-striped table-bordered table-condensed" id="myTable" style="width:50%; margin:0 auto;">
            ...
            <tbody>
            	<tr>
            		<td class="modif">
            			<input class="input-sm2" type="text" id="base1" value="400" readonly/>
            		</td>
            		<td class="modif">
            	...
            	<tr>
            		...
            		<td class="modif">
            			<input class="input-sm2" type="text" id="altura7" readonly=""/>
            		</td>
            	</tr>
            </tbody>
        </table>
	</div>
	<input type="button" class="btn btn-success btn-sm" onclick="valida8();" value="Verificar" />
	<br /><br /><br />
