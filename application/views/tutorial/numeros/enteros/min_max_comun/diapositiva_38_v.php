...
<div class="container-fluid" id="div_1" style="display: block">
	...
	<input type="button" class="btn btn-success btn-sm input-top5" onclick="verificar38();" value="Verificar" />
...
<div class="container-fluid" id="div_2" style="display: none">
	...
	<div class="table-responsive div-border0">
		...
		<label> = </label> <input class="input-sm input-top5" size="15" type="text" id="2" />
	</div>
	<input type="button" class="btn btn-success btn-sm input-top5" onclick="verificar38_1();" value="Verificar" />
	<input type="button" class="btn btn-success btn-sm input-top5" onclick="ejercicio3();" value="Más ejercicios" />		
	<br />
</div>
