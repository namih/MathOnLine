...
<div class="container-fluid">
	...
	<div class="table_responsive div-border0"><label>125 = </label> <input class="input-sm input-top5" size="2" type="text" id="num1" /> <label> X </label><input class="input-sm input-top5" size="2" type="text" id="num2" /> <label> X </label><input class="input-sm input-top5" size="2" type="text" id="num3" /></div>
