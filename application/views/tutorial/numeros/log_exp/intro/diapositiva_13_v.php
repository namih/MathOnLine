    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-justify">
        <p>
            ...
            <div style="display:inline-block">
                <math xmlns="http://www.w3.org/1998/Math/MathML"><msup><mn>4</mn><mfrac><mn>1</mn><mn>2</mn></mfrac></msup><mo>&#xA0;</mo><mo>=</mo></math>
            </div>
            <div style="display: inline-block">
        ...
        <button type="button" class="btn btn-success" onclick="validateSqrt(2)">Verificar</button>
