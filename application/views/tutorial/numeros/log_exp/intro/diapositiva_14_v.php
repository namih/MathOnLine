    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-justify">
        <p>
            ...
            <div style="display: inline-block">
                <math xmlns="http://www.w3.org/1998/Math/MathML"><msup><mn>1600</mn><mfrac><mn>5</mn><mn>2</mn></mfrac></msup><mo>&#xA0;</mo><mo>=</mo></math> =
                (
            ...
            <div style="display: inline-block">
                <input type="number" id="answer" class="form-control" readonly>
            </div>
        </p>
        ...
        <button type="button" class="btn btn-success" onclick="validateSqrt2(102400000)">Verificar</button>
