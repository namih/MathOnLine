...
function verificar(){
	...
	var num7 = new Number($("#7").val());
	var num8 = new Number($("#8").val());
	...
	&& document.getElementById("6").value != '' && document.getElementById("7").value != '' && document.getElementById("8").value != '' ) {
		if (isNaN(num1)||isNaN(num2)||isNaN(num3)||isNaN(num4)||isNaN(num5)||isNaN(num6)||isNaN(num7)||isNaN(num8)) {
			...
			var array_num_multi = [num5,num6,num7,num8];
			...
			var array_order_multi = array_num_multi.sort(function(a, b){return a-b});
			var tamanio_multi = array_order_multi;
			
			if(tamanio_9.length == 2 && tamanio_10.length == 2 && tamanio_multi.length == 4){
				if((this.compara_array(array_order_9,numeros9,2)) == true && (this.compara_array(array_order_10,numeros10,2)) == true && (this.compara_array(array_order_multi,multiplica,4)) == true){
